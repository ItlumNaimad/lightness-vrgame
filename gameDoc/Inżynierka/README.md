...
- **Ballora (Donośność i tłumienie pozytywki):** Zbalansowano model tłumienia (`unit_size = 2.8m`, `max_distance = 32.0m`, `volume_db = 4.5 dB`), dzięki czemu pozytywka płynnie cichnie z odległością, umożliwiając intuicyjne namierzanie wroga.
